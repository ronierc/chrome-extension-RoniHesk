...
document.querySelectorAll('table.white td:nth-child(11)').forEach((item) => {
  ...
  item.innerHTML = `
    <span title="Atualizado à: ${item.parentNode.querySelector('table.white td:nth-of-type(4)').innerText}" 
      id="diasAberto" style="background: ${dias <= 10 ? 'var(--purple)' : '#ff0033'};">
      ${dias}
    </span>
  `;
})
